...
%\input{chapters/2_estado_arte.tex}
%\input{chapters/3_propuesta.tex}
%\input{chapters/4_kitti.tex}
%\input{chapters/5_deteccion2d.tex}
%\input{chapters/6_aprox_distancia.tex}
%\input{chapters/7_roi.tex}
%\input{chapters/8_deteccion3d.tex}
%\input{chapters/9_completo.tex}
%\input{chapters/10_conclusiones.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{appendices}
  %\input{Book/appendix/manual.tex}
  %\input{Book/appendix/pliego.tex}
  %\input{Book/appendix/presupuesto.tex}
\end{appendices}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
